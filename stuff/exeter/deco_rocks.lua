...
for grid_count = 1,6 do
	...
	minetest.register_node("exeter:small_rocks"..grid_count, {
...
minetest.register_node("exeter:small_rocks", {
	description = "Small Rocks",
...
minetest.register_craft({
	...
	recipe = {
		{"", "", ""},
		{"exeter:small_rocks", "exeter:small_rocks", ""},
		{"exeter:small_rocks", "exeter:small_rocks", ""},
	},
})
